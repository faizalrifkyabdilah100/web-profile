...
<div>
    ...
    <section class="relative pt-24 pb-16 lg:pt-32 lg:pb-24 flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 overflow-hidden text-center">
        ...
        <div class="relative z-10 text-white px-4 max-w-4xl mx-auto" data-aos="zoom-in" data-aos-duration="1000">
            <h1 class="text-4xl md:text-6xl mb-6 font-bold tracking-tight">Tambah Data Guru</h1>
            <p class="text-xl text-blue-100 max-w-2xl mx-auto font-light leading-relaxed">
                Lengkapi formulir di bawah untuk menambahkan data guru baru
            </p>
        </div>
    </section>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-white">Formulir Data Guru</h2>
                            <p class="text-blue-100 text-sm">Isi data guru dengan lengkap dan benar</p>
                        </div>
                    </div>
                </div>

                <form action="<?= base_url('guru/store') ?>" method="post" enctype="multipart/form-data" class="p-8">
                    <?= csrf_field() ?>
                    ...
                    <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8 pt-6 border-t border-gray-100">
                        ...
                        <button type="submit" 
                                class="px-8 py-3 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all duration-300 inline-flex items-center justify-center gap-2 hover:shadow-lg hover:-translate-y-0.5">
